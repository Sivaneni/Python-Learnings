...
if __name__ == "__main__":
    pdf_path = r'C:\Users\Welcome\Desktop\Generative AI\learnpython\projects\Project4\content\sample.pdf'
    output_file_path = r'C:\Users\Welcome\Desktop\Generative AI\learnpython\projects\Project4\extracted_text.txt'

    # Read configuration from a file (e.g., config.ini)
    config = configparser.ConfigParser()
    config.read(r'C:\Users\Welcome\Desktop\Generative AI\learnpython\projects\Project4\config.ini')
